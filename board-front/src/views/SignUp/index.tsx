...
//          render: 인증 화면 컴포넌트 렌더링          //
return (
  <div id='auth-wrapper-sign'>
    <div className = 'sinUp-container'>
    <div className='sign-up-background-image'>
    </div>
    <div className='titles'>흙수저 레시피</div>
    <div className='description'>우리가 가장 중요하게 생각하는 점은 레시피에 대한 이해도입니다 그런 면에서 이 흙수저 레시피는 독자들이 이해하기 쉽게 쓰여진 아주 훌륭한 레시피입니다 </div>
    <div className='right'>
    </div>
    </div>
    {view === 'sign-up' && <SignUpCard />}
